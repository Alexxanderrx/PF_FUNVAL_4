    ...
    return (
        <>
            ...
            <div className="h-16 w-11/12  flex justify-between items-center">
                ...
                <form action={"http://127.0.0.1:8000/api/rol/create" + params.id} method="POST">
                    {usuario.id_rol == 1 ? (
                        <button
                                    ...
                                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                        ...
                                        <div className="relative p-6 flex flex-col gap-6">
                                            <div className="flex items-center">
                                                ...
                                                <input className="" type="text" name="rol" required />
                                            </div>
                ...
                <p className="text-xs md:text-base"><a href="/dashboard" className=" text-sky-500">Home</a> / <span>{props.name + "s"}</span></p>
            </div>
                                                                ...
                                                                <div className="relative w-auto my-6 mx-auto max-w-sm">
                                                                    ...
                                                                    <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                                                        ...
                                                                        <div className="relative p-6 flex flex-col gap-4">
                                                                            <div className="flex">
                                                                                <span className="mr-4 text-sm font-medium text-gray-900 dark:text-gray-300">Nuevo nombre :</span>
