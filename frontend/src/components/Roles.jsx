    ...
    return (
        <>
            <div className="h-16 w-11/12  flex justify-between items-center">
                <p id="title01" className="truncate  text-xl md:text-2xl font-medium pr-4">Roles</p>
                <p className="text-xs md:text-base"><a href="./lobby.php" className=" text-sky-500">Home</a> / <span id="title02">Roles</span></p>
            </div>
