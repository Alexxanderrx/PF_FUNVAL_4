...
export default function MenuName(props) {
    ...
    return (
        <div className="bg-[#f1f3f5] h-screen w-screen flex">
            ...
            <div className="flex flex-col h-full w-5/6 justify-between items-center">
                <section className=" flex flex-col w-full h-[90%] justify-start items-center">
                    <nav className="h-[11.5%] w-full bg-white flex md:justify-between justify-end items-center border">
                        ...
                        <ul id="toggle" ref={toggleBarRef} className="flex flex-col justify-center items-center py-4  md:w-48 w-40 border rounded-b-xl bg-white absolute right-0 md:top-[10.3%] top-[63px] collapse z-10">
                            ...
                            <div className="w-11/12">
                                <a href="/" className="hover:bg-gray-200 text-red-600 flex justify-start items-center rounded-2xl px-4">
                    ...
                    <div className=" flex flex-col w-full justify-start items-center h-[88.5%]">
                        {props.render()}
                    </div>
