    ...
    return (
        <div className="bg-[#f1f3f5] h-screen w-screen flex">
            <section id="toggleMenu" className="h-full w-1/6 bg-[#30363b]">
                <Link to={"/dashboard/" + params.id} id="toggleMenuU" className="h-16 w-full border-b flex md:justify-start justify-center md:pl-4 items-center">
                ...
                <div id="" className="md:flex hidden h-28 w-full border-b flex-col justify-around items-start text-white p-4">
                    ...
                    <div className="truncate w-full">
                        {persona != "" ? (((persona.primer_nombre == null) ? "" : persona.primer_nombre)
                ...
                <div className="w-full flex flex-col justify-center items-center text-white">
                    ...
                    <Link to={"/dashboard/" + params.id} id="" className="w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                    ...
                    <Link to={"/roles/" + params.id} id="" className=" w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                    ...
                    <Link to={"/usuarios/" + params.id} id="" className=" w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                    ...
                    {usuario.id_rol == 1 ? (<>
                        <Link to={"/bitacoras/" + params.id} id="" className=" w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                        ...
                        {/* <Link to={"/enlaces/" + params.id} id="" className=" w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                        ...
                        <Link to={"/paginas/" + params.id} id="" className=" w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                ...
                <section className=" flex flex-col w-full h-[90%] justify-start items-center">
                    <nav className="h-[11.5%] w-full bg-white flex md:justify-between justify-end items-center border">
                        ...
                        <div id="open" ref={btnOpenRef} onClick={open} className="flex h-full md:w-48 w-40 justify-end items-center px-4 hover:bg-[#f2f2f2]">
                            <div className="pr-2 w-full text-center truncate">
                                {persona != "" ? (((persona.primer_nombre == null) ? "" : persona.primer_nombre)
                                    + " " + ((persona.segundo_nombre == null) ? "" : persona.segundo_nombre)
                                    + " " + ((persona.primer_apellido == null) ? "" : persona.primer_apellido)
                                    + " " + ((persona.segundo_apellido == null) ? "" : persona.segundo_apellido)) :
                        ...
                        <ul id="toggle" ref={toggleBarRef} className="flex flex-col justify-center items-center py-4  md:w-48 w-40 border rounded-b-xl bg-white absolute right-0 md:top-[10.3%] top-[63px] collapse z-10">
                            ...
                            <div className=" w-11/12 border-b border-gray">
                                <Link to={"/profile/" + params.id} className="hover:bg-gray-200 w-full flex justify-start items-center rounded-2xl px-4">
                            ...
                            <div className="w-11/12">
                                <Link to="/" className="hover:bg-gray-200 text-red-600 flex justify-start items-center rounded-2xl px-4">
