    ...
    return (
        <div className="w-screen h-screen flex border justify-center items-center">
            <div className=" flex flex-col justify-center items-center h-full md:h-[480px] w-screen  md:w-96 ">
                <form
                    className=" flex-col h-full md:h-[460px] w-full md:w-96 p-4 md:p-10 border-0 md:border border-gray-400 rounded-3xl"
                    ...
                    <div className=" text-gray-500 flex text-xs justify-center">
                        <p>Don't you have an account yet?</p>
                        <p className=" text-sky-500"><a href="/register">&#160;Register</a></p>
                    </div>
