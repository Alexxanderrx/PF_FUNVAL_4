...
export default function InfoP() {
    ...
    // useEffect(() => {
    //     axios
    //         .get("http://127.0.0.1:8000/api/cookieU")
    //         .then((response) => {
    ...
    return (
        <div className="flex  flex-col justify-center items-center h-[50rem] w-screen">
            <nav className="flex  md:px-10 px-6 w-full h-16 justify-between items-center ">
                <div className="w-32">
                ...
                ?> */}
                    ...
                    <p className=" md:visible collapse pl-4 pr-4"></p>
                    {/* <svg id="spin" style="transition-duration: 500ms;" className="md:visible collapse w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="-8 0 30 10">
                        <path d="M15.434 1.235A2 2 0 0 0 13.586 0H2.414A2 2 0 0 0 1 3.414L6.586 9a2 2 0 0 0 2.828 0L15 3.414a2 2 0 0 0 .434-2.179Z" />
                    </svg> */}

                </div>
                <ul id="toggle" className="flex flex-col justify-center items-center  md:h-44 md:w-48  h-36 w-40 border rounded-xl bg-white absolute right-10 md:top-16 top-12 collapse">
